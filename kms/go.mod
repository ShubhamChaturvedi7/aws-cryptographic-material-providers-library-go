module github.com/ShubhamChaturvedi7/aws-cryptographic-material-providers-library-go/kms

go 1.23.0

require (
	github.com/ShubhamChaturvedi7/aws-cryptographic-material-providers-library-go/smithy-dafny-standard-library v0.0.0-20250107234600-190c1a53e242
